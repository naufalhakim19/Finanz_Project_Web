            ...
            <div class="card">
                <div class="card-header pt-4">
                    <div class="top d-flex row align-items-center justify-content-between">
                        <h3 class="mt-2 mx-3">Status Budget</h3>
                        <div class="top-right">
                    ...
                    <ul class="nav nav-tabs card-title" id="myTab" role="tablist">
                        <li class="nav-item active">
                            <a class="nav-link active show" id="home-tab" data-toggle="tab" href="#terima" role="tab"
                                aria-controls="terima" aria-selected="false">Budget Accepted</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tolak" role="tab"
                                aria-controls="tolak" aria-selected="false">Budget Rejected</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="#realisasi" data-toggle="tab" role="tab" aria-controls="realisasi"
                                aria-selected="false">Relized Budget</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active show" id="terima" role="tabpanel"
                                            ...
                                            <table class="table table-bordered" id="table-datatable" style="width: 100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th rowspan="2" class="text-center">NOMINAL PCS</th>
                                                        <th rowspan="2" class="text-center">QUANTITY</th>
                                                        <th rowspan="2" class="text-center">TOTAL</th>
                                                        <th rowspan="2" class="text-center">STATUS</th>
                                                        @if (Auth::user()->level == 'bendahara')
                                                            <th rowspan="2" class="text-center" width="10%">OPTION
                                                            </th>
                                                        @endif
                                                    </tr>
                                                </thead>
                                                        ...
                                                        @if ($a->status != 'Realisasi')
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    {{ date('F Y', strtotime($a->bulan)) }}</td>
                                                                <td class="text-center">{{ $a->kategori->kategori }}</td>
                                                                <td class="text-center">{{ $a->keterangan }}</td>
                                                                <td class="text-center">
                                                                    {{ 'Rp.' . number_format($a->nominal_per_pcs) . ',-' }}</td>
                                                                <td class="text-center">{{ $a->jumlah_barang }}</td>
                                                                <td class="text-center">
                                                                    {{ 'Rp.' . number_format($a->nominal_total) . ',-' }}</td>
                                                                <td class="text-center">{{ $a->status }}</td>
                                                                @if (Auth::user()->level == 'bendahara')
                                                                    <td class="text-center">
                                                                        @if ($a->status != 'Realisasi')
                                                                            <button type="button"
                                                                                title="Realisasikan Anggaran"
                                                                                class="btn btn-success btn-sm"
                                                                                data-toggle="modal"
                                                                                data-target="#modalEdit_{{ $a->id }}">
                                                                                <i class="fa fa-exchange"></i>
                                                                            </button>

                                                                            <!-- Modal -->
                                                                            <form method="POST"
                                                                                action="{{ route('anggaran.aksi.realisasi', ['id' => $a->id]) }}"
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                ...
                                                                                                <div class="form-group"
                                                                                                    ...
                                                                                                    <p>Bulan Anggaran yang
                                                                                                        direncana kan :
                                                                                                        {{ date('F Y', strtotime($a->bulan)) }}
                                                                                                    </p>
                                                                                                    <label>Tanggal</label>
                                                                                                    <input type="text"
                                            ...
                                            <div class="d-flex justify-content-end align-items-center">
                                                ...
                                                @if ($anggaranTerima->lastpage() > 1)
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="pagination">
                                                            <li class="page-item {{ $anggaranTerima->currentPage() == 1 ? ' disabled' : '' }}"
                                                                title="Halaman Pertama">
                                                                <a class="page-link" href="{{ $anggaranTerima->url(1) }}"
                                                                    aria-label="Previous">
                                                            ...
                                                            @for ($i = 1; $i <= $anggaranTerima->lastPage(); $i++)
                                                                ...
                                                                ?>
                                                                @if ($from < $i && $i < $to)
                                                                    <li class="page-item {{ $anggaranTerima->currentPage() == $i ? ' active' : '' }}"
                                                                        title="Halaman {{ $i }}">
                                                                        <a class="page-link"
                                                                            href="{{ $anggaranTerima->url($i) }}">{{ $i }}</a>
                                                                    </li>
                                                                @endif
                                                            @endfor
                                                            <li class="page-item {{ $anggaranTerima->currentPage() == $anggaranTerima->lastPage() ? ' disabled' : '' }}"
                                                                title="Halaman Terakhir">
                                                                <a class="page-link"
                                                                    href="{{ $anggaranTerima->url($anggaranTerima->lastPage()) }}"
                                                                    aria-label="Next">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="d-flex justify-content-end align-items-center">
                                                ...
                                                @if ($anggaranTolak->lastpage() > 1)
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="pagination">
                                                            <li class="page-item {{ $anggaranTolak->currentPage() == 1 ? ' disabled' : '' }}"
                                                                title="Halaman Pertama">
                                                                <a class="page-link" href="{{ $anggaranTolak->url(1) }}"
                                                                    aria-label="Previous">
                                                                    <i class="fa fa-fast-backward" aria-hidden="true"></i>
                                                                    <span class="sr-only">Previous</span>
                                                                </a>
                                                            ...
                                                            @for ($i = 1; $i <= $anggaranTolak->lastPage(); $i++)
                                                                ...
                                                                ?>
                                                                @if ($from < $i && $i < $to)
                                                                    <li class="page-item {{ $anggaranTolak->currentPage() == $i ? ' active' : '' }}"
                                                                        title="Halaman {{ $i }}">
                                                                        <a class="page-link"
                                                                            href="{{ $anggaranTolak->url($i) }}">{{ $i }}</a>
                                                                    </li>
                                                                @endif
                                                            @endfor`
                                                            <li class="page-item {{ $anggaranTolak->currentPage() == $anggaranTolak->lastPage() ? ' disabled' : '' }}"
                                                                title="Halaman Terakhir">
                                                                <a class="page-link"
                                                                    href="{{ $anggaranTolak->url($anggaranTolak->lastPage()) }}"
                                                                    aria-label="Next">
                                                                    <i class="fa fa-fast-forward" aria-hidden="true"></i>
                                                                    <span class="sr-only">Next</span>
                                                                </a>
                                            ...
                                            <div class="table table-bordered" id="table-datatable" style="width: 100%">
                                                <table>
                                                    <thead>
                                                        <tr>
                                                            <th rowspan="2" class="text-center" width="1%">NO</th>
                                                            <th rowspan="2" class="text-center" width="11%">TANGGAL
                                                            </th>
                                                            <th rowspan="2" class="text-center">KATEGORI</th>
                                                            <th rowspan="2" class="text-center">KETERANGAN</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    @if ($t->keterangan != '')
                                                                        ...
                                                                        <?php
                                                                        $anggaranReal = DB::table('anggaran')
                                                                            ->where('id', '=', $t->anggaran_id)
                                                                            ->first();
                                                                        ...
                                                                        <div class="modal fade" id="imageModal"
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <img id="image"
                                                                                            src="{{ asset('gambar/kwitansi_transaksi/' . $t->foto_kwitansi) }}"
                                                                                            alt="Click on button"
                                                                                            style="width: 100%" />
                                                                                    </div>
                                                ...
                                                <div class="d-flex justify-content-end align-items-center">
                                                    ...
                                                    @if ($transaksi->lastpage() > 1)
                                                        <nav aria-label="Page navigation example">
                                                            <ul class="pagination">
                                                                <li class="page-item {{ $transaksi->currentPage() == 1 ? ' disabled' : '' }}"
                                                                    title="Halaman Pertama">
                                                                    <a class="page-link" href="{{ $transaksi->url(1) }}"
                                                                        aria-label="Previous">
                                                                ...
                                                                @for ($i = 1; $i <= $transaksi->lastPage(); $i++)
                                                                    ...
                                                                    @endif
                                                                @endfor
                                                                <li class="page-item {{ $transaksi->currentPage() == $transaksi->lastPage() ? ' disabled' : '' }}"
                                                                    title="Halaman Terakhir">
                                                                    <a class="page-link"
                                                                        href="{{ $transaksi->url($transaksi->lastPage()) }}"
                                                                        aria-label="Next">
