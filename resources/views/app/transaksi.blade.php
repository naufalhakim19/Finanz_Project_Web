            ...
            <div class="card">
                ...
                <div class="card-header pt-4 d-flex justify-content-between align-items-center">
                    <div class="header-left d-flex row align-items-center">
                        <h4 class="mt-2 mr-2">Transaction</h4>
                        @if (Auth::user()->level == 'bendahara')
                            <button type="button" title="Tambahkan Transaksi" class="btn btn-finanz mx-1" data-toggle="modal"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-transform: uppercase" class="form-control"
                                                name="no_kwitansi" autocomplete="off"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required="required" name="jenis">
                                                ...
                                                <option value="Pengeluaran">Expenses</option>
                                            </select>
                                        </div>
                            ...
                            <table class="table table-bordered" id="table-datatable" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" width="11%">DATE</th>
                                        ...
                                        <th rowspan="2" class="text-center">NO RECEIPT</th>
                                        <th rowspan="2" class="text-center">FOTO RECEIPT</th>
                                        @if (Auth::user()->level == 'bendahara')
                                            ...
                                            <td class="text-center">
                                                @if ($t->foto_kwitansi != '')
                                                    <button type="button" class="btn btn-light" data-toggle="modal"
                                                        data-target="#imageModal"><i class="fa fa-picture-o"></i></button>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <img id="image"
                                                                        ...
                                                                        alt="Click on button" style="width: 100%" />
                                                                </div>
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item {{ $transaksi->currentPage() == $transaksi->lastPage() ? ' disabled' : '' }}"
                                                ...
                                                <a class="page-link" href="{{ $transaksi->url($transaksi->lastPage()) }}"
                                                    aria-label="Next">
